...
const ForgotPassword = () => {
  ...
  return (
    <Container fluid className={`vh-100 ${resetPasswordClass['main-container']}`}>
      <Row className='h-100 mx-2'>
        ...
        >
          <div className='w-75 h-75 border-box grid gap-5 '>
            ...
            <div className='w-100 h-50 mt-5'>
              ...
              <p className='mb-4'>After reset password you redirect to login page</p>
              ...
              <div className='card border-0 d-flex justify-content-center align-items-center mt-3 w-100'>
                <p className={resetPasswordClass['p-know']} onClick={() => navigate('/')}>Know your password? Login Now</p>
              </div>
              </div>
          </div>
        </Col>
        ...
        >
          <Card as={'div'} border='0' className={`d-md-flex justify-content-center align-items-center ${resetPasswordClass['imgSubContainer']}`}>
            <img
              src={authImg}
              alt='Login'
              className={resetPasswordClass['img-fluid']}
